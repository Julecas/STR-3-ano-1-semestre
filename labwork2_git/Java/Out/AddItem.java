...
public class AddItem {
    ...
    public void AddItems(Scanner scanner, DateTimeFormatter formatter, Mechanism  Mec, Stock stock ) throws InterruptedException{
        ...
        while(true){
            ...
            while(true){
                ...
                //CHECKING VIA SENSOR
                if(Mec.checkCell(z, x) == true) {
                    System.out.println("Sensor: posição ocupada");
                }else{
                    System.out.println("Sensor: posição livre");
                }
